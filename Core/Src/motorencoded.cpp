...
motor_encoded::motor_encoded(Motor_config *m_config, Encoder_config *e_config) : motors(m_config) {
...
void motor_encoded::motorEncodedInit(Motor_config *m_config, Encoder_config *e_config) {
...
void motor_encoded::runAngle() {
	...
	if (pulsesFound == pulsesNeeded || (pulsesFound >= pulsesNeeded * 0.99 && pulsesFound <= pulsesNeeded * 1.01)) {
